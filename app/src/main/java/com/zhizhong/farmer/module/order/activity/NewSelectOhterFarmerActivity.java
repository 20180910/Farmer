...
public class NewSelectOhterFarmerActivity extends BaseActivity implements LoadMoreAdapter.OnLoadMoreListener{
    ...
    protected int getContentView() {
        ...
        return R.layout.act_select_other_farmer_new;
    }
